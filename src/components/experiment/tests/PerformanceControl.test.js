...
it("PerformanceControl renders with content", () => {
  ...
  act(() => {
    render(<ExperimentContext.Provider 
          value={{ getExperimentPerformanceMetrics: () => null, experiment: experiment, loadingPerformance: false }}>
...
it("PerformanceControl renders with content but no experiment", () => {
  ...
  act(() => {
    render(<ExperimentContext.Provider 
          value={{ getExperimentPerformanceMetrics: () => null, experiment: null, loadingPerformance: false }}>
            <TreeContext.Provider value={{ enabledTreeSearch: true }} >
              <PerformanceControl />
            </TreeContext.Provider>            
          </ExperimentContext.Provider>
