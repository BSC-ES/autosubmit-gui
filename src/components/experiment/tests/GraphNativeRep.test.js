...
const data = {
  ...
  nodes: [
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0000_POST"],
      chunk: 1,
      custom_directives: [],
      dashed: true,
      date: "1960 01 01",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0001_POST"],
      chunk: 6,
      custom_directives: [],
      dashed: true,
      date: "1960 06 01",
      ...
      parent_list: ["a34f_19600101_fc0000_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0002_POST"],
      chunk: 4,
      custom_directives: [],
      dashed: true,
      date: "1960 04 01",
      ...
      parent_list: ["a34f_19600101_fc0001_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0003_POST"],
      chunk: 2,
      custom_directives: [],
      dashed: true,
      date: "1960 02 01",
      ...
      parent_list: ["a34f_19600101_fc0002_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0004_POST"],
      chunk: 9,
      custom_directives: [],
      dashed: true,
      date: "1960 09 01",
      ...
      parent_list: ["a34f_19600101_fc0003_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0005_POST"],
      chunk: 7,
      custom_directives: [],
      dashed: true,
      date: "1960 07 01",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0006_POST"],
      chunk: 3,
      custom_directives: [],
      dashed: true,
      date: "1960 03 01",
      ...
      parent_list: ["a34f_19600101_fc0005_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0007_POST"],
      chunk: 6,
      custom_directives: [],
      dashed: true,
      date: "1960 06 01",
      ...
      parent_list: ["a34f_19600101_fc0006_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0008_POST"],
      chunk: 7,
      custom_directives: [],
      dashed: true,
      date: "1960 07 01",
      ...
      parent_list: ["a34f_19600101_fc0007_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
    ...
    {
      children: 1,
      children_list: ["a34f_19600101_fc0009_POST"],
      chunk: 5,
      custom_directives: [],
      dashed: true,
      date: "1960 05 01",
      ...
      parent_list: ["a34f_19600101_fc0008_POST"],
      parents: 1,
      platform_name: null,
      priority: 1,
      processors: "1",
...
test("Add fake edge to visNetwork", () => {
  ...
  expect(Object.keys(state.visNetwork.body.data.edges._data)).toContain(
    source + "-" + target
  );
...
test("Add fake edge to visNetwork using non-existent nodes", () => {
  ...
  addFakeEdge(source, target, state);
  expect(Object.keys(state.visNetwork.body.data.edges._data)).not.toContain(
    source + "-" + target
  );
  //console.log(Object.keys());
});
...
test("Update edge style succeeds", () => {
  ...
  expect(
    state.visNetwork.body.edges[idEdge].options.background.enabled
  ).toEqual(true);
  expect(state.visNetwork.body.edges[idEdge].options.background.color).toEqual(
    "rgba(63, 191, 63, 0.5)"
  );
});
...
test("Update graph border suceeds", () => {
  ...
  expect(
    state.visNetwork.body.nodes[nodeId].options.shapeProperties.borderDashes
  ).toBe(true);
});
...
test("Update the color of a node in the graph", () => {
  ...
  const selectedNode = state.visNetwork.getSelectedNodes()[0];
  expect(selectedNode).toEqual(nodeId);
  expect(state.visNetwork.body.nodes[nodeId].options.color.background).toEqual(
    "yellow"
  );
});
...
test("Update the shape of a node in the graph", () => {
  ...
  //     nodeId
  //   ].options.shape);
  expect(state.visNetwork.body.nodes[nodeId].options.shape).toEqual("square");
});
