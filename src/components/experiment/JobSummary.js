      ...
      <div>
        ...
        >
          <span
            ...
            title='Shows a summary of the Queue and Run times per type of job.'
          >
            Summary
          </span>
        </button>
          ...
          <div className='modal-dialog modal-dialog-summary' role='document'>
            <div className='modal-content'>
                  ...
                  <p>
                    <small>
                      <span className='text-muted'>
                        Queue and Run in <strong>seconds</strong> when{" "}
                        <strong>exported</strong>,{" "}
                        <span className='badge badge-primary'>blue</span>{" "}
                        button. Only COMPLETED or RUNNING jobs are listed.
                      </span>
                    </small>
                  </p>
                </h5>
              ...
              <div className='modal-body scroll-x-table'>
                ...
                {sourceData && sourceData.length === 0 && (
                  <p>
                    There are no RUNNING or COMPLETED jobs in this instance of
                    the experiment.
                  </p>
                )}
              </div>
