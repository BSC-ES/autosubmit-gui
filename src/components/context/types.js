...
export const SET_CURRENT_UPDATE_DESCRIP_COMMAND = "SET_CURRENT_UPDATE_DESCRIP_COMMAND";
...
export const CLEAR_CURRENT_CONFIGURATION_DATA="CLEAR_CURRENT_CONFIGURATION_DATA";
