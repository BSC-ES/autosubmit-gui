/*
 Constants that apply in state management
*/
...
export const EXPAND_ALL_TREE_DATA = "EXPAND_ALL_TREE_DATA";
export const COLLAPSE_ALL_TREE_DATA = "COLLAPSE_ALL_TREE_DATA";
export const SAVE_TREE_LAYOUT = "SAVE_TREE_LAYOUT";
export const RESET_TREE_LAYOUT = "RESET_TREE_LAYOUT";
...
export const SET_CURRENT_UPDATE_DESCRIP_COMMAND =
  "SET_CURRENT_UPDATE_DESCRIP_COMMAND";
export const GET_LOG_RUNNING_DATA = "GET_LOG_RUNNING_DATA";
export const SET_WARNING_ACTIVE = "SET_WARNING_ACTIVE";
// Job History Log
export const GET_JOB_HISTORY_LOG = "GET_JOB_HISTORY_LOG";
export const CLEAR_JOB_HISTORY_LOG = "CLEAR_JOB_HISTORY_LOG";
// LIGHTER VIEW
...
export const SET_PERFORMANCE_DISPLAY = "SET_PERFORMANCE_DISPLAY";
// JOB HISTORY
...
export const UPDATE_DESCRIPTION_OWN_EXP = "UPDATE_DESCRIPTION_OWN_EXP";
export const SEARCH_BY_OWNER = "SEARCH_BY_OWNER";
export const GET_CURRENT_CONFIGURATION = "GET_CURRENT_CONFIGURATION";
export const CLEAR_CURRENT_CONFIGURATION_DATA =
  "CLEAR_CURRENT_CONFIGURATION_DATA";
export const TEST_TOKEN = "TEST_TOKEN";

// PANEL
export const SET_JOB_INFO_PANEL_VISIBILITY = "SET_JOB_INFO_PANEL_VISIBILITY";

// PAGINATION
export const SET_PAGINATED_RESULT = "SET_PAGINATED_RESULT";
export const SET_CURRENT_PAGE = "SET_CURRENT_PAGE";
export const ORDER_EXPERIMENTS_RESULT = "ORDER_EXPERIMENTS_RESULT";

// STATS
export const APPLY_FILTER = "APPLY_FILTER";
export const SET_FILTER_CHART = "SET_FILTER_CHART";
